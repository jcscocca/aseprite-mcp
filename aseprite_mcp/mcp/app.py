...
server = FastMCP(
    ...
    instructions=(
        ...
        "Typical workflow:\n"
        "  1. create_canvas() — new sprite file (pick a palette preset or pass "
        "hex colors); or import_image() to start from an existing PNG "
        "(≤1024px per side, optional indexed conversion against a palette)\n"
